...
errorhandler:
    ...
    Exit Sub
End Sub
Public Sub SendCraftin(ByVal CraftIndex As Long)
Dim Buffer As clsBuffer
    ...
    Set Buffer = New clsBuffer
    Buffer.WriteLong CCraft
    Buffer.WriteLong CraftIndex
    SendData Buffer.ToArray()
    Set Buffer = Nothing
    ...
    Exit Sub
errorhandler:
    HandleError "SendCraft", "modClientTCP", Err.Number, Err.Description, Err.Source, Err.HelpContext
    Err.Clear
    Exit Sub
End Sub
