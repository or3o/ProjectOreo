...
Dim BlockRect As RECT, WarpRect As RECT, ItemRect As RECT, ShopRect As RECT, EventNpcRect As RECT, EventTileRect As RECT, NpcOtherRect As RECT, PlayerRect As RECT, PlayerPkRect As RECT, NpcAttackerRect As RECT, NpcShopRect As RECT, NadaRect As RECT, CraftRect As RECT, ResourceRect As RECT, WaterRect As RECT
         ...
         ' Draw Outline
                 For X = 0 To MapX
                         For Y = 0 To MapY
                                         ...
                                         CameraY = 55 + (Y * 4)
                                         RenderTexture Tex_White, CameraX, CameraY, NadaRect.Left, NadaRect.Top, NadaRect.Right - NadaRect.Left, NadaRect.Bottom - NadaRect.Top, NadaRect.Right - NadaRect.Left, NadaRect.Bottom - NadaRect.Top, D3DColorRGBA(255, 255, 255, 150)
                         Next Y
                Next X
                ' *****************
                ' *** Atributos ***
                                ...
                                For Y = 0 To MapY
                                        ...
                                        CameraY = 55 + (Y * 4)
                                                Select Case Map.Tile(X, Y).Type
                                                                Case TileBlocked
                                                                                RenderTexture Tex_White, CameraX, CameraY, BlockRect.Left, BlockRect.Top, BlockRect.Right - BlockRect.Left, BlockRect.Bottom - BlockRect.Top, BlockRect.Right - BlockRect.Left, BlockRect.Bottom - BlockRect.Top, D3DColorRGBA(156, 102, 31, 205)
                                                                Case TileWarp
                                                                                RenderTexture Tex_White, CameraX, CameraY, WarpRect.Left, WarpRect.Top, WarpRect.Right - WarpRect.Left, WarpRect.Bottom - WarpRect.Top, WarpRect.Right - WarpRect.Left, WarpRect.Bottom - WarpRect.Top, D3DColorRGBA(75, 0, 155, 200)
                                                                Case TileItem
                                                                                RenderTexture Tex_White, CameraX, CameraY, ItemRect.Left, ItemRect.Top, ItemRect.Right - ItemRect.Left, ItemRect.Bottom - ItemRect.Top, ItemRect.Right - ItemRect.Left, ItemRect.Bottom - ItemRect.Top, D3DColorRGBA(0, 155, 0, 200)
                                                                Case TileShop
                                                                                RenderTexture Tex_White, CameraX, CameraY, ShopRect.Left, ShopRect.Top, ShopRect.Right - ShopRect.Left, ShopRect.Bottom - ShopRect.Top, ShopRect.Right - ShopRect.Left, ShopRect.Bottom - ShopRect.Top, D3DColorRGBA(255, 125, 0, 200)
                                                                Case TileCraft
                                                                                RenderTexture Tex_White, CameraX, CameraY, CraftRect.Left, CraftRect.Top, CraftRect.Right - CraftRect.Left, CraftRect.Bottom - CraftRect.Top, CraftRect.Right - CraftRect.Left, CraftRect.Bottom - CraftRect.Top, D3DColorRGBA(139, 134, 130, 85)
                                                                Case TileResource
                                                                         RenderTexture Tex_White, CameraX, CameraY, CraftRect.Left, ResourceRect.Top, ResourceRect.Right - ResourceRect.Left, ResourceRect.Bottom - ResourceRect.Top, ResourceRect.Right - ResourceRect.Left, ResourceRect.Bottom - ResourceRect.Top, D3DColorRGBA(128, 0, 0, 128)
                                                                Case TileWater
                                                                                RenderTexture Tex_White, CameraX, CameraY, WaterRect.Left, WaterRect.Top, WaterRect.Right - WaterRect.Left, WaterRect.Bottom - WaterRect.Top, WaterRect.Right - WaterRect.Left, WaterRect.Bottom - WaterRect.Top, D3DColorRGBA(28, 134, 238, 156)
                                ...
                                If GetPlayerMap(i) = GetPlayerMap(MyIndex) Then
                                                Select Case Player(i).PK
                                                                Case 0
                                                                                ...
                                                                                RenderTexture Tex_White, CameraX, CameraY, PlayerRect.Left, PlayerRect.Top, PlayerRect.Right - PlayerRect.Left, PlayerRect.Bottom - PlayerRect.Top, PlayerRect.Right - PlayerRect.Left, PlayerRect.Bottom - PlayerRect.Top, D3DColorRGBA(0, 255, 0, 200)
                                                                Case 1
                                                                                CameraX = CameraXSize - (MapX * 4) + (MiniMapPlayer(i).X)
                                                                                CameraY = 55 + (MiniMapPlayer(i).Y)
                                                                                RenderTexture Tex_White, CameraX, CameraY, PlayerPkRect.Left, PlayerPkRect.Top, PlayerPkRect.Right - PlayerPkRect.Left, PlayerPkRect.Bottom - PlayerPkRect.Top, PlayerPkRect.Right - PlayerPkRect.Left, PlayerPkRect.Bottom - PlayerPkRect.Top, D3DColorRGBA(100, 0, 0, 200)
                                                End Select
                                End If
                        End If
                Next i
