...
Begin VB.Form frmEditor_Resource 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ListBox lstIndex 
         Height          =   6720
         ItemData        =   "frmEditor_Resource.frx":3366
         Left            =   120
         List            =   "frmEditor_Resource.frx":3368
         TabIndex        =   1
         Top             =   240
         Width           =   2895
      End
...
Private Sub Form_Load()
    ...
    lstIndex.AddItem Resource(i).Name
    Next
    ' Error handler
    Exit Sub
errorhandler:
...
Private Sub txtEXP_Change()
  ' If debug mode, handle error then exit out
    ...
    If IsNumeric(txtEXP.text) Then Resource(EditorIndex).EXP = Val(txtEXP.text)
